...
public class TestEntity extends TestEntityParent {
  ...
  public TestEntity() {
    ...
    floatField = (float) byteField;
    doubleField = (double) byteField;
    stringField = "TestEntity-" + byteField;
  ...
  public boolean equals(Object other) {
    ...
    return Objects.equals(byteField, entity.byteField)
        && Objects.equals(shortField, entity.shortField)
