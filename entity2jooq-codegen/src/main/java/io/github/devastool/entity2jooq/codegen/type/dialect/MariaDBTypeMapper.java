...
/**
 * Implementation of {@link DialectTypeMapper} for mapping type of MariaDB dialect.
 *
 * @author Sergey_Konovalov
 * @since 1.0.0
 */
public class MariaDBTypeMapper extends DialectTypeMapper {
  private static final String DIALECT = "MariaDB";
  ...
  public MariaDBTypeMapper() {
    ...
    super(
        ...
        Set.of(
            ...
            new TypePair(OffsetDateTime.class, "datetime with time zone"),
            new TypePair(ZonedDateTime.class, "datetime with time zone"),
            // Boolean types
