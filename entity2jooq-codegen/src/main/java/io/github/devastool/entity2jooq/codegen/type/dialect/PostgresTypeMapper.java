...
/**
 * Implementation of {@link DialectTypeMapper} for mapping type of Postgres dialect.
 *
 * @author Andrey_Yurzanov
 * @since 1.0.0
 */
public class PostgresTypeMapper extends DialectTypeMapper {
  ...
  public PostgresTypeMapper() {
    // TODO. bytea, interval, currency, json, jsonb.
    super(
        DIALECT,
        Set.of(
            // Numeric types
